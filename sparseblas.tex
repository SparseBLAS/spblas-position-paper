...
\IfFileExists{minted2.sty}
  {\usepackage[newfloat,outputdir=build]{minted2}}
...
% *** NEW  ***
% Summary table (AI Generated!)
% -> Skip on the detailed API calls in favour of direct information lookup for reader (API differences)
\begin{table*}[t]
  \centering
...
% -> Better acmart treatment of single-listing intead of enumeration of 12
% -> Compressed version (take less space but removed some details)
\begin{listing}[htbp]
