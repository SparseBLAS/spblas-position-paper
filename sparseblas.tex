...
In this first edition, we propose a non-owning non-opaque API. As discussed, a opaque, owning API allows the libraries to perform additional optimization, such as lazy evaluation of routines. We postpone the design of such an API to the future. 
