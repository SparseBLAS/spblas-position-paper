...
This requires to consider a wide range of design aspects, ranging from storage formats over ownership and opaqueness of objects to functionality scope, multi-stage functions and execution policies. 
...
The functionality we consider in scope of this paper is listed in~\Cref{sec:functionality}. Instead of discussing the the characteristics of the distinct sparse BLAS routines individually, we identify in~\Cref{sec:archetype} a set of archetypes that represent functionality groups. Before identifying archetypes and listing sparse BLAS functionality, the question of sparse storage formats is addressed in~\Cref{sec:sparse-formats}. In~\Cref{sec:ownership}, we discuss the opaqueness and ownership of the sparse objects, and how a combination of data wrappers and objects can be used to find a balance between accessibility and performance optimization aspects.
