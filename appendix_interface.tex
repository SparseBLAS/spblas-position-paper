...
GrB_apply(x, GrB_NULL, GrB_NULL, GrB_TIMES_FP64, alpha, x, GrB_NULL); /* |$x = \alpha \cdot x$| */
GrB_apply(y, GrB_NULL, GrB_NULL, GrB_TIMES_FP64, beta, y, GrB_NULL); /* |$y = \beta \cdot y$| */
GrB_mxm(y, GrB_NULL, GrB_PLUS_FP64, GrB_PLUS_TIMES_SEMIRING_FP64, A, x, GrB_NULL); /* |$y \mathrel{+}= A \cdot x$| */
